    ...
    return (
      <div id="home-component" class="panel-lg z-depth-5" style={{height: '100%'}}>
        <div class="home-div1">
            ...
            <div style={{width: '50%'}}>
                <p style={{fontSize: '18px'}}>We develop with your needs in mind.</p>
                <p style={{fontSize: '18px'}}>Engineers and analysts on our team possess a passion for learning
                ...
                <br/>
                <p style={{fontSize: '18px'}}>The end result? A solution that has been delivered with you in mind, but nothing short of
                    performant.</p>
            </div>
        </div>
      </div>
