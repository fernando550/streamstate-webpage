...
export const Help = () => {
    return (
      <div className="dashboard-child-component">
        <div className="row z-depth-5 fileupload-func-panel">
          <h5 className="bold">Welcome to StreamState's Twitter Data Tool</h5>
          ...
          <p className="bold">{`There are currently three functions in the dashboard that this tool performs:`}</p>
          <ol>
            <li className="bold">{`
